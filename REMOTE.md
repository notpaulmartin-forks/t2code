...
Use this when you want to open T2 Code from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The T2 Code CLI accepts the following configuration options, available either as CLI flags or environment variables:
